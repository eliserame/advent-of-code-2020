...
object NavigationComputer {
  ...
  def execute(instructions: Seq[(Char, Int)]): Int = {
  ...
  def executeWithWaypoint(instructions: Seq[(Char, Int)]): Int = {
  ...
  def main(args: Array[String]): Unit = {
    val input = InputReader.readLines("src/main/resources/input-12")
